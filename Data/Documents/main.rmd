...
\begin{center}
Prepared for Energy Finance 2017
...
Developing a trading strategy requires the awareness of several key facts. First, in a world absent transaction costs, any deviation from the mean should spur immediate mean reversion no matter how small, as noted by Balke and Famby [-@10.2307/2527284]. In this study, some transaction costs are included by construction, as the trading simulation assumes that all purchases are make on the ask and all sales made on the bid. This is a simplifying assumption, as this merely accounts for explicit transaction costs, and not implicit costs such as opportunity cost and market impact, among others.
